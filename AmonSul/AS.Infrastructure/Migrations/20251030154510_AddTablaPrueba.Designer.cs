...
namespace AS.Infrastructure.Migrations
{
    ...
    [Migration("20251030154510_AddTablaPrueba")]
    partial class AddTablaPrueba
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AS.Domain.Models.ConfiguracionSistema", b =>
                {
                    ...
                    b.Property<string>("ValorConfiguracion")
                        ...
                        .HasColumnName("Valor_Configuracion");

                    b.HasKey("IdConfiguracion")
                        .HasName("PK__ConfiguracionSistema__IdConfiguracion");

                    b.HasIndex("NombreConfiguracion")
                        .IsUnique()
                        .HasDatabaseName("IX_ConfiguracionSistema_NombreConfiguracion");
            ...
            modelBuilder.Entity("AS.Domain.Models.TablaPrueba", b =>
                {
                    ...
                    b.Property<DateTime>("FechaCreacionPrueba")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasColumnName("Fecha_Creacion_Prueba")
                        .HasDefaultValueSql("GETDATE()");
                    ...
                    b.HasKey("IdPrueba")
                        .HasName("PK__TablaPrueba__IdPrueba");

                    b.ToTable("Tabla_Prueba", (string)null);
                });
