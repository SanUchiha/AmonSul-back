...
namespace AS.Infrastructure.Migrations
{
    ...
    [Migration("20251030163517_AddClasificacionEloCacheTable")]
    partial class AddClasificacionEloCacheTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AS.Domain.Models.ClasificacionEloCache", b =>
                {
                    ...
                    b.Property<int>("AnioClasificacion")
                        .HasColumnType("int")
                        .HasColumnName("Anio_Clasificacion");
                    ...
                    b.Property<int>("NumeroPartidasJugadas")
                        .HasColumnType("int")
                        .HasColumnName("Numero_Partidas_Jugadas");
                    ...
                    b.HasKey("IdClasificacion")
                        .HasName("PK__ClasificacionEloCache__IdClasificacion");

                    b.HasIndex("AnioClasificacion")
                    ...
                    b.HasIndex("IdUsuario", "AnioClasificacion")
                        .IsUnique()
                        .HasDatabaseName("IX_ClasificacionEloCache_Usuario_Anio");

                    b.ToTable("Clasificacion_Elo_Cache", (string)null);
                });
            ...
            modelBuilder.Entity("AS.Domain.Models.ClasificacionEloCache", b =>
                {
                    b.HasOne("AS.Domain.Models.Faccion", "Faccion")
                        .WithMany()
